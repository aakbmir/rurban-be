...
//    @Query("select b from CheckIns b where b.clinicId = :clinicId order by checkInDate desc")
    @Query("select b from CheckIns b")
    List<CheckIns> findByClinicId(Clinic clinicId);

//    @Query("select b from CheckIns b where b.patientId = :userId order by checkInDate desc")
    @Query("select b from CheckIns b")
